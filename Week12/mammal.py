...
class Mammal:
    def __init__(self, p_age, tick=None):  # Aggregation through parameter
        ...
        self.age = p_age  # ✅ Ensure age is a public attribute
    ...
    def __str__(self):
        ...
        return f"Mammal(age={self.age}, live_birth={self.__live_birth}, tick={tick_status}, heart_bpm={self.heart.beats_per_minute})"
